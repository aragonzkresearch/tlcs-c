...
const char *dst = "BLS_SIG_BLS12381G2_XMD:SHA-256_SSWU_RO_NUL_";	// LOE incorrectly uses this domain also for hashing to G1. They acknowledged the bug but for compatibility it must stay unchainged.
int
pairing_init (void)
{
