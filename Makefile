...
DFLAGS1=-DPARALLELISM=0 -D_DEBUG_=1 -DCYC_GRP_BLS_G1=0
...
demo_prover: src/cyclic_group.c src/err.c src/pairing.c src/prover.c src/verifier.c src/invert.c src/aggregate.c src/serialize.c src/tests/simulated_loe.c examples/demo_prover.c src/global_bufs.c
	$(CC) -o  bin/demo_prover src/cyclic_group.c src/err.c src/pairing.c src/prover.c src/verifier.c src/aggregate.c src/invert.c src/serialize.c src/tests/simulated_loe.c examples/demo_prover.c src/global_bufs.c $(IOPT)  $(LDFLAGS) $(DFLAGS2) $(CCOPT)
demo_aggregator: src/cyclic_group.c src/err.c src/pairing.c src/prover.c src/verifier.c src/invert.c src/aggregate.c src/serialize.c src/tests/simulated_loe.c examples/demo_aggregator.c src/global_bufs.c
	$(CC) -o  bin/demo_aggregator src/cyclic_group.c src/err.c src/pairing.c src/prover.c src/verifier.c src/aggregate.c src/invert.c src/serialize.c src/tests/simulated_loe.c examples/demo_aggregator.c src/global_bufs.c $(IOPT)  $(LDFLAGS) $(DFLAGS2) $(CCOPT)
