...
demo_invert: src/cyclic_group.c src/err.c src/pairing.c src/prover.c src/verifier.c src/invert.c src/aggregate.c src/serialize.c src/tests/simulated_loe.c examples/demo_invert.c
	$(CC) -o  bin/demo_invert src/cyclic_group.c src/err.c src/pairing.c src/prover.c src/verifier.c src/aggregate.c src/invert.c src/serialize.c src/tests/simulated_loe.c examples/demo_invert.c $(IOPT)  $(LDFLAGS) $(DFLAGS0) $(CCOPT)
clean:
