...
## Overview
The repository provides implementation of the efficient TLCS protocol described in this [note](https://hackmd.io/WYp7A-jPQvK8xSB1pyH7hQ) that builds on the LOE/[drand](https://github.com/drand/drand) service. The implementation is based on the [mcl](https://github.com/herumi/mcl/) library By Shigeo Mitsunari/and openssl.
