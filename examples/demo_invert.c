...
printf("\nGive me a signature in hexadecimal format for the round %" SCNu64 "\n You can find it here: https://api.drand.sh/dbd506d6ef76e5f386f41c651dcb808c5bcbd75471cc4eafa3f4df7ad4e4c493/public/",round);
printf("%" SCNu64 "/\n",round);
...
while(1){
 ...
 DeserializePartyOutput(&P[i].PK, &P[i].pi,serialized_proof+tmplen,&size);
tmplen+=size;
